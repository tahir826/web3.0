...
var accountNumber : number = 8866
var pin : number = 1234
var balance : number = 5000
...
function greetings(timeOnClock: number) {
    let greet: string = '';
...
let timeOnClock: number = 10; // use time 24 hours (0 - 23):
console.log(greetings(timeOnClock));

var classsNumber:number = 12
if (classsNumber == 0){
